...
var SelectAll = (function (_super) {
    ...
    SelectAll.prototype.render = function () {
        ...
        return (react_1.default.createElement(ButtonComponent, __assign({ ref: this.getRootRef, className: "selectable-select-all ".concat(className), onClick: this.context.selectable.selectAll }, rest), children));
    };
