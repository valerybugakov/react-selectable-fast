...
class DeselectAll extends react_1.Component {
    constructor() {
        super(...arguments);
        this.root = null;
        this.getRootRef = (ref) => {
    ...
    render() {
        ...
        return (react_1.default.createElement(ButtonComponent, { ref: this.getRootRef, className: `selectable-select-all ${className}`, onClick: this.context.selectable.clearSelection, ...rest }, children));
    }
}
